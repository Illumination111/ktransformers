...
ACCELERATE_CONFIG="${ACCELERATE_CONFIG:-examples/ktransformers/accelerate/fsdp2_kt_int8_1gpu_lowmem.yaml}"
TRAIN_YAML="${TRAIN_YAML:-examples/ktransformers/train_lora/deepseek_v32_lora_sft_kt.yaml}"
